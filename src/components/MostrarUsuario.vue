    ...
    methods: {
        ...
        estadoUsuario(user) {
            ...
            if (user.estado == 1) {
                ...
                axios
                    .put(
                        `https://labficat.herokuapp.com/api/usuario/desactivar/${user._id}`, header)
                    .then((res) => {
                        console.log(res.data.usuario);
                        this.traerUsuarios();
                    })
                ...
                axios
                    .put(
                        `https://labficat.herokuapp.com/api/usuario/vacaciones/${user._id}`, header)
                    .then((res) => {
                        console.log(res.data.usuario);
                        this.traerUsuarios();
                    })
                ...
                console.log(header);
                axios
                    .put(`https://labficat.herokuapp.com/api/usuario/activar/${user._id}`, header)
                    .then((res) => {
                        console.log(res.data.usuario);
                        this.traerUsuarios();
                    })
