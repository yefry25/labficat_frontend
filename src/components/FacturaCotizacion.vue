        ...
        ">
            ...
            <v-row no-gutters>
                <v-col cols="6" class="py-0 px-0">
                    <v-row>
                        <v-col cols="4" class="text-center pr-0">
                            ...
                            <p :style="{ background: color, color: 'white' }" class="datos mb-0 py-01">
                                Dirección
                            </p>
                            <p :style="{ background: color, color: 'white' }" class="datos mb-0 py-01">
                                Departamento
                        ...
                        <v-col cols="8" class="pl-0">
                            ...
                            <p class="parra pl-1 py-0 my-0">
                                {{ fecha(person.validezOferta) }}
                            </p>
                ...
                <v-col cols="6" class="py-0 px-0">
                    <v-row>
                        <v-col cols="4" class="text-center pr-0">
                            <p :style="{ background: color, color: 'white' }" class="parra mb-0 py-0">
                                NIT / C.C.
                            </p>
                            <p :style="{ background: color, color: 'white' }" class="parra mb-0 py-0">
                                Ciudad
                        ...
                        <v-col cols="8" class="pl-0">
                            ...
                            <p class="parra pl-1 py-0 my-0">
                                {{ fecha(person.entregaResultados) }}
                            </p>
            ...
            <v-row no-gutters style="border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black">
                <v-col>
            ...
            <v-row no-gutters style="border-left: solid 1px black; border-right: 1px solid black">
                <v-col cols="10">
                ...
                <v-col cols="2" style="border-left: solid 1px black">
                    <h5 class="text-center">
                        {{ valores(this.$store.state.facturaCotizacion.items.item1.costo) }}
                    </h5>
                </v-col>
            </v-row>
            <v-row no-gutters style="border: solid 1px black">
            ...
            <v-row no-gutters style="border-left: solid 1px black; border-right: 1px solid black">
                ...
                <v-col cols="2" style="border-left: solid 1px black">
                    <h5 class="text-center">
                        {{ valores(this.$store.state.facturaCotizacion.items.item2.costo) }}
                    </h5>
                </v-col>
            </v-row>
            <v-row no-gutters style="border: solid 1px black">
            ...
            <v-row no-gutters style="border-left: solid 1px black; border-right: 1px solid black">
                ...
                <v-col cols="2" style="border-left: solid 1px black">
                    <h5 class="text-center">
                        {{ valores(this.$store.state.facturaCotizacion.items.item3.costo) }}
                    </h5>
                </v-col>
            </v-row>
            <v-row no-gutters>
                <v-col cols="8" style="border-left: solid 1px black; border-bottom: solid 1px black; border-top: solid 1px black">
                    <h5 class="primary text-center white--text">
                        Observaciones de la propuesta técnica y económica
                    </h5>
                </v-col>
                <v-col cols="2" style="border-left: solid 1px black; border-bottom: solid 1px black; border-top: solid 1px black">
                    <h5 class="primary text-center white--text">Subtotal</h5>
                </v-col>
                <v-col cols="2" style="
            border-left: solid 1px black;
            border-right: solid 1px black;
          ...
          ">
                    <h5 class="text-center">
                        {{ valores(this.$store.state.facturaCotizacion.subTotal) }}
                    </h5>
                </v-col>
            </v-row>
            <v-row no-gutters>
                ...
                <v-col cols="2" style="border-left: solid 1px black; border-bottom: solid 1px black">
                    <h5 class="primary text-center white--text">IVA</h5>
          ...
          ">
                    ...
                    <h5 class="text-center" style="border-top: solid 1px black">
                        {{ valores(this.$store.state.facturaCotizacion.total) }}
                    </h5>
                </v-col>
            </v-row>
            <v-row no-gutters>
            ...
            <v-row no-gutters>
                <v-col>
                    <p class="text">
                        ...
                        2. En caso de solicitar alguna modificación o inclusión al servicio
                        se debe solicitar al correo electrónico institucional
                        labficat@sena.edu.co. <br />
                        3. Las muestras deben ser recolectadas por el cliente. Se entregará
                        copia No controlada del Instructivo de toma de muestras
                        CAT–ST–MU–F–001 vigente como apoyo para el proceso de muestreo. 4.
                        Los ensayos que no cuenten con símbolo de referencia indica: Ensayo
                        sin acreditación y sin habilitación. <br />
                        5. Los ensayos referenciados con (°) se encuentran habilitados por
                        estandares de calidad ante la Secretaria de Salud Departamental
                        (SSD). <br />
                        6. Los ensayos referenciados con (*) se encuentran acreditados ante
                        el Organismo Nacional de Acreditación (ONAC). <br />
                        7. El laboratorio se abstiene de emitir declaraciones de
          ...
          ">
            ...
            <v-row no-gutters>
                <v-col cols="2">
                    <h5 class="text-center white--text" :style="{
                        background: color,
                        borderLeft: 'solid 1px black',
                        borderRight: 'solid 1px black',
                    }">
            ...
            <v-row no-gutters>
                <v-col>
                    <p class="text">
                        ...
                        fin de realizar las modificaciones necesarias y actualizar la
                        versión de la cotización, para proceder a la aceptación de la misma.
                        <br />
                        - La aceptación de la propuesta implica que el cliente esta de
                        acuerdo con todas las condiciones aquí descritas, incluyendo que las
                        muestras se analicen por las técnicas, métodos y limites de
                        ...
                        análisis o modificar los resultados del servicio.
                    </p>
                </v-col>
            </v-row>
            <v-row no-gutters>
          ...
          ">
            ...
            <v-row no-gutters>
                <v-col>
                    <p class="text">
                        '- Forma de Pago: se debe realizar la totalidad del pago de la
                        presente oferta antes de iniciar los análisis de las muestras
                        recepcionadas en el laboratorio. <br />
                        - El pago podrá efectuarse en efectivo en las oficinas del Centro
                        Agroturístico o mediante consignación a la siguiente cuenta bancaria
                        a nombre de SENA: BANCO No. XXXXXXXXX. - Únicamente se dará por
                        cancelado el servicio una vez se envíe la copia de consignación al
                        correo electrónico institucional labficat@sena.edu.co <br />
                        - La recepción y procesamiento de las muestras se realizara dentro
                        de los días hábiles Lunes a Viernes de 08:00 am - 12:00 pm y 02:00
                        pm - 05:00 pm. <br />
                        ...
                        laboratorio, teniendo en cuenta que solo cuentan días hábiles.
                        <br />
            ...
            border-bottom: solid 1px black;
          ">
                    <h5 class="primary text-center white--text">Condiciones técnicas</h5>
                </v-col>
            </v-row>
            <v-row no-gutters>
                <v-col>
                    <p class="text">
                        ...
                        servicio, contrato o aceptación del servicio.
                    </p>
                </v-col>
            </v-row>
            <v-row no-gutters>
            ...
            border-bottom: solid 1px black;
          ">
                    <h5 class="primary text-center white--text">Garantía del servicio</h5>
                </v-col>
            </v-row>
            <v-row no-gutters>
                <v-col>
                    <p class="text">
                        '- Se entregará copia No controlada del Instructivo de toma de
                        muestras CAT–ST–MU–F–001 vigente como apoyo para el proceso de
                        muestreo que es responsabilidad del cliente, donde se especifican
                        las condiciones y recomendaciones a tener en cuenta cuando se
                        efectué el muestreo, LABFICAT solo se hace responsable del ítem de
                        ensayo desde el momento de la recepción de la muestra y no garantiza
                        los criterios de calidad considerados durante la recolección. <br />
                        ...
                        electrónico institucional al cliente que la información será
                        divulgada siempre y cuando la ley no lo prohíba.
                    </p>
                </v-col>
            </v-row>
            <v-row no-gutters>
            ...
            border-bottom: solid 1px black;
          ">
                    <h5 class="primary text-center white--text">Calidad del servicio</h5>
                </v-col>
            </v-row>
            <v-row no-gutters>
                <v-col>
                    <p class="text">
                        '- LABFICAT se encuentra en proceso de acreditación ante el
                        Organismo Nacional de Acreditación (ONAC) bajo la norma NTC ISO/IEC
                        17025:2017 en la matriz de Alimentos. <br />
                        ...
                        - LABFICAT participa en Pruebas de Desempeño anualmente conforme a
                        lo establecido en el inciso a) del numeral 7.7.2. Aseguramiento de
                        la validez de los resultados de la norma NTC ISO/IEC 17025:2017.
                    </p>
                </v-col>
            </v-row>
        </v-col>
...
export default {
    ...
    methods: {
        ...
        infoCotizacionEditar() {
            console.log(this.$store.state.facturaCotizacion.numCotizacion);
            ...
            for (
                ...
                const element = this.$store.state.facturaCotizacion.items.item2.itemsEnsayo[i];
            ...
            for (
                ...
                const element = this.$store.state.facturaCotizacion.items.item3.itemsEnsayo[i];
