  ...
  <v-container fluid>
    <v-row>
      <v-col cols="2" class="py-1" align="center">
        ...
        <svg xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:cc="http://creativecommons.org/ns#"
          ...
          xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape" width="130" height="110"
    ...
    <v-row class="my-0">
      <v-col cols="2" class="text-center px-0">
        <p for="Name" :style="{ background: color }" class="label mb-0">Quien entrega las muestras</p>
        <p for="Name" :style="{ background: color }" class="label mb-0">C.C.</p>
        <p for="Name" :style="{ background: color }" class="label mb-0">Firma</p>
      </v-col>
      ...
      <v-col cols="3" class="text-center px-0">
        ...
        <p for="Name" :style="{ background: color }" class="label mb-0">Quien recibe las muestras</p>
        <p for="Name" :style="{ background: color }" class="label mb-0">Firma</p>
      </v-col>
