  ...
  <v-container fluid style="height: 100%">
    ...
    <v-row>
      <v-col cols="6" class="py-0 px-0">
        <v-row>
          <v-col cols="4"   class="text-center px-0">
            <p for="Name"  :style="{background:color}" class="label mb-0 ">Solicitante</p>
            <p for="Name"  :style="{background:color}" class="label mb-0 ">NIT / C.C.</p>
            <p for="Name"  :style="{background:color}" class="label mb-0 ">Dirección</p>
            <p for="Name"  :style="{background:color}" class="label mb-0 ">Ciudad</p>
          </v-col>
      ...
      <v-col cols="6" class="py-0 px-0">
        <v-row>
          <v-col cols="4" class="text-center px-0">
            <p for="Name" :style="{background:color}" class="label mb-0">Departamento</p>
            <p for="Name" :style="{background:color}" class="label mb-0">Contacto</p>
            <p for="Name" :style="{background:color}" class="label mb-0">Teléfono</p>
            <p for="Name" :style="{background:color}" class="label mb-0">Correo electrónico</p>
          </v-col>
          <v-col cols="8" class="pl-0">
    ...
    <v-row>
      <v-col cols="6" class="py-0 px-0">
        <v-row>
          <v-col cols="4" class="text-center px-0">
            <p for="Name" :style="{background:color}" class="label mb-0">Mun de recolección</p>
            <p for="Name" :style="{background:color}" class="label mb-0">Dirección de toma de muestra</p>
            <p for="Name" :style="{background:color}" class="label mb-0">Lugar de toma de muestra</p>
            <p for="Name" :style="{background:color}" class="label mb-0">Muestra recolectada por</p>
          </v-col>
          <v-col cols="8" class="pl-0">
      ...
      <v-col cols="6" class="py-0 px-0">
        <v-row>
          <v-col cols="4" class="text-center px-0">
            <p for="Name" :style="{background:color}" class="label mb-0">Procedimiento de muestreo</p>
            <p for="Name" :style="{background:color}" class="label mb-0">Tipo de muestra</p>
            <p for="Name" :style="{background:color}" class="label mb-0">Matriz de la muestra</p>
            <p for="Name" :style="{background:color}" class="label mb-0">Fecha y hora de recolección</p>
          </v-col>
          <v-col cols="8" class="pl-0">
