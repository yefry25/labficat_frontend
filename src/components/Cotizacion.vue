      ...
      <v-col cols="6" class="py-0 px-0">
        <v-row>
          <v-col cols="4" class="text-center px-0">
            <p for="Name" :style="{ background: color }" class="label mb-0">
              Clientes
                            ...
                            <v-card outlined>
                              <v-card-title>
                                <v-hover v-slot="{ hover }">
                                  <v-btn icon @click="{ dialogNuevoRegistro = false }"
                              ...
                              <v-card-actions>
                                <v-spacer></v-spacer>
                                <v-hover v-slot="{ hover }">
                                  <v-btn class="ml-5" text @click="{ dialogNuevoRegistro = false }"
            ...
            <p for="Name" :style="{ background: color }" class="label mb-0">Celular</p>
            <p for="Name" :style="{ background: color }" class="label mb-0">Validez de la oferta</p>
            <p for="Name" :style="{ background: color }" class="label mb-0">Elaborado por</p>
          </v-col>
      ...
      <v-col cols="6" class="py-0 px-0">
        <v-row>
          <v-col cols="4" class="text-center pr-0">
            ...
            <p for="Name" :style="{ background: color }" class="label mb-0">Cargo</p>
            <p for="Name" :style="{ background: color }" class="label mb-0">Correo electrónico</p>
            <p for="Name" :style="{ background: color }" class="label mb-0">Entrega de resultados</p>
            <p for="Name" :style="{ background: color }" class="label mb-0">Cargo</p>
          </v-col>
          <v-col cols="8" class="pl-0">
