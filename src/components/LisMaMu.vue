  ...
  data() {
    return {
      ...
      header: [
        ...
        {
          text: "Departamento",
          value: "solicitante.ciudad.departamento",
          sortable: false,
        },
        ...
        {
          text: "Dirección toma muestra",
          value: "direccionTomaMuestra",
          sortable: false,
        },
        {
          text: "Lugar toma muestra",
          value: "lugarTomaMuestra",
          sortable: false,
        },
        {
          text: "Muestra recolectada por",
          value: "muestraRecolectadaPor",
          sortable: false,
        },
        {
          text: "Procedimiento muestreo",
          value: "procedimientoMuestreo",
          sortable: false,
        },
        { text: "Tipo muestra", value: "tipoMuestra.tipos", sortable: false },
        { text: "Matriz muestra", value: "matrizMuestra", sortable: false },
        {
          text: "Fecha recoleccion muestra",
          value: "fechaRecoleccion",
          sortable: false,
        },
        {
          text: "Cotización",
          value: "cotizacion.numCotizacion",
          sortable: false,
        },
        { text: "Item cotización", value: "item", sortable: false },
        {
          text: "Fecha recepción muestra",
          value: "createdAt",
          sortable: false,
        },
        { text: "Fecha emisión muestra", value: "metodo", sortable: false },
        {
          text: "Fecha entrega resultados",
          value: "cotizacion.entregaResultados",
          sortable: false,
        },
        {
          text: "Seguimiento entrega resultados",
          value: "metodo",
          sortable: false,
        },
